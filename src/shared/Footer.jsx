...
<footer className="py-lg-8 py-5 backgraundFooter">
    <div className="container">
        <div className="row  justify-content-center text-center  ">
            <div className="col-12 col-md-12 col-xl-8 px-0 ">
            ...
            <div className="col-lg-8 col-md-12 col-12">
                <div className="my-6">
                    ...
                    <a href="#" className="me-4 text-white" aria-label="Instagram">
